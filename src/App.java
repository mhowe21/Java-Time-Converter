...
public class App {
    ...
    /**
     * The main function of the program. It prompts the user to select an option and performs the corresponding action.
     *
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (keepGoing == true) {
            ...
            // if the user selects 1, it will print the current time in the local time zone zone
            if (optionSelect == 1) {
                ...
                System.out.println();
            // if the user selects 2, it will print the current time in the Zulu time zone (Universal time)
            ...
            // this gets the offset from 2 diffrent timezones
                ...
                // if the timezone the user enters does not exist it will print an error and ask them to use option 5 to get all timezones
                try{
